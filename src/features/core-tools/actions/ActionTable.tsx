...
const EMPTY_MESSAGE = 'Không có hành động nào.';
...
export function ActionTable({ data, loading, onEdit, onDelete }: Props) {
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-slate-200 bg-slate-50">
              ...
              <th className="px-3 py-2 text-left font-semibold text-slate-700">Mã quyền</th>
  ...
  return (
    ...
    >
      <Column
        ...
        style={{ width: '80px' }}
      />
      <Column field="code" header="Mã quyền" />
