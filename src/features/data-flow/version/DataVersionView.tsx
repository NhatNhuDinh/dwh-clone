...
import { VersionSteps } from '@/features/data-flow/version/VersionSteps';
import { OrganizationTable } from '@/features/data-flow/version/OrganizationTable';
import { versionOrganizationsMock } from '@/features/data-flow/version/data';
...
export function DataVersionView({ flowType: _flowType }: Props) {
