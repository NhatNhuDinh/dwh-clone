...
const EMPTY_MESSAGE = 'Không có nhật ký truy cập nào.';

type Props = {
  data: AccessLogItem[];
  loading?: boolean;
  onViewDetail?: (row: AccessLogItem) => void;
};

export function AccessLogTable({ data, loading, onViewDetail }: Props) {
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-slate-200 bg-slate-50">
              ...
              <th className="w-28 px-3 py-2 text-left font-semibold text-slate-700">Xem chi tiết</th>
            </tr>
          </thead>
          <tbody>
            <tr>
